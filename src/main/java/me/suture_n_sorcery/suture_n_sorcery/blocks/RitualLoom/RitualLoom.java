...
public class RitualLoom extends Block implements BlockEntityProvider {
    ...
    public void onPlaced(World world, BlockPos pos, BlockState state, @Nullable LivingEntity placer, ItemStack itemStack) {
        ...
        // make sure the second half has room before placing it
        assert placer != null;
    ...
    private static BlockPos getMainPos(BlockPos pos, BlockState state) {
        if (state.get(PART) == RitualLoomPart.MAIN) return pos;
        return pos.offset(getLinkDirectionToOtherHalf(state));
    }
