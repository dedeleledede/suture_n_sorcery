...
import me.suture_n_sorcery.suture_n_sorcery.client.screens.CondensatorScreen;
...
public class Suture_n_sorceryClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        HandledScreens.register(ModScreenHandlers.CONDENSATOR_SCREEN, CondensatorScreen::new);
    }
}
