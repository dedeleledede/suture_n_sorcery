...
## Design Pillars
- **Blood is a material**, not a color. It has weight, cost, and purpose.
- **Ritual-first progression**: power comes from preparation.
- **Industrial occult**: tools that look functional… until you notice what they’re made for.
- **Atmosphere**: subtle audio/visual cues, moody interfaces.
- **Risk & restraint**: shortcuts exist, but they tend to cut *you* too.

---

## Requirements
- Minecraft **1.21.10**
- Fabric Loader (latest for 1.21.10)
